...
// a mic reading, added 2026-08-18 per Caelan, replacing the old "Score
// breakdown" section on the detail screen. Feeds the same quietness score
...
class LoudnessVoteButtons extends StatefulWidget {
  ...
  /// Same sign-in gate MicReadingControl uses — voting needs a real
  /// account so the pipeline can tell whose vote this is (and whether a
  /// mic reading from that same account supersedes it).
